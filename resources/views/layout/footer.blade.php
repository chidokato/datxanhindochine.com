        ...
        <div class="row row-cols-lg-3 row-cols-md-2 row-cols-1">
            ...
            <div class="col">
                <div class="footer-widget contact-widget mb-4">
                    <h3 class="widget-title mb-4">Thông tin liên hệ</h3>
                    <ul>
            ...
            <div class="col">
                <div class="footer-widget newslatter-widget mb-4">
                    <h4 class="widget-title mb-4">Đăng ký nhận thông tin</h4>
...
<div class="copyright bg-footer text-default py-4">
    <div class="container">
        <div class="row row-cols-md-2 row-cols-1">
            <div class="col">
                <span class="text-white">© 2023 Bản quyền thuộc về Indochine</span>
            </div>
            <div class="col">
                ...
                <div class="row row-cols-xl-2 row-cols-1">
                    <div class="col">
                        <div class="overflow-hidden position-relative transation thumbnail-img bg-secondary hover-img-zoom m-2">
                            ...
                            <a href="#"><img class="w-100 lazyload" data-src="frontend/assets/images/property/2.png" alt=""></a>
                    ...
                    <div class="col">
                        <div class="property_text transation py-3 pe-3">
                            ...
                            <div class="d-flex align-items-center post-meta mt-2 py-3 border-top">
                                <div class="agent">
                                    <a href="#" class="d-flex text-general align-items-center"><img class="rounded-circle me-2" src="frontend/assets/images/team/1.jpg" alt="avata"><span>Ali Tufan</span></a>
                                </div>
