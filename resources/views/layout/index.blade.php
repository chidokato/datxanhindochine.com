...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('')}}data/home/{{$setting->favicon}}" />
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-0X5LQXK8P1"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'G-0X5LQXK8P1');
    </script>
